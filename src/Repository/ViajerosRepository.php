...
/**
 * @extends ServiceEntityRepository<Viajeros>
 */
class ViajerosRepository extends ServiceEntityRepository implements PasswordUpgraderInterface
{
